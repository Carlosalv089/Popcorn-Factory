...
class MenuActivity : AppCompatActivity() {
    var catalogo = ArrayList<Pelis>()
    var adapter: PeliculasAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = PeliculasAdapter(catalogo, this)
        gridview.adapter = adapter
    }

    fun cargarPeliculas(){
        catalogo.add(Pelis("Big Hero", R.drawable.bighero6, R.drawable.headerbighero6,
        ...
        catalogo.add(Pelis("1917", R.drawable.mil, R.drawable.milheader,
        ...
        catalogo.add(Pelis("Leap Year", R.drawable.leapyear, R.drawable.leapyearheader,
        ...
        catalogo.add(Pelis("Men in Black", R.drawable.mib, R.drawable.mibheader,
        ...
        catalogo.add(Pelis("Toy Story", R.drawable.toystory, R.drawable.toystoryheader,
        ...
        catalogo.add(Pelis("Inception", R.drawable.inception, R.drawable.inceptionheader,
        ...
        catalogo.add(Pelis("Doctor House", R.drawable.drhouse, R.drawable.drwhoheader,
        ...
        catalogo.add(Pelis("Smallville", R.drawable.smallville, R.drawable.smallvilleheader,
        ...
        catalogo.add(Pelis("Dr. Who", R.drawable.drwho, R.drawable.drwhoheader,
        ...
        catalogo.add(Pelis("Bones", R.drawable.bones, R.drawable.bonesheader,
        ...
        catalogo.add(Pelis("Suits", R.drawable.suits, R.drawable.suitsheader,
            "While running from a drug deal gone bad, brilliant young college dropout Mike Ross slips into a job " +
                    ...
                    "possible."))
        catalogo.add(Pelis("Friends", R.drawable.friends, R.drawable.friendsheader,
...
class PeliculasAdapter : BaseAdapter{
    var catalogo = ArrayList<Pelis>()
    var context: Context? = null


    constructor(catalogo: ArrayList<Pelis>, context: Context?): super(){
        this.catalogo = catalogo
        this.context = context
    }

    override fun getView(position: Int, contentView: View?, parent: ViewGroup?): View {
        var pelicula = catalogo[position]
        var inflator = context!!.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        var vista = inflator.inflate(R.layout.activity_pelicula, null)

        var img = vista.findViewById(R.id.iv_peliculas) as ImageView
        var txt = vista.findViewById(R.id.tv_titulo_pelicula) as TextView
        img.setImageResource(pelicula.image)
        txt.setText(pelicula.nombre)
